...
* 此源码包为精锋微控提供的安诺机器人Probot Anno源码包，其中已包含ROS环境下Probot Anno基础模型的搭建
* 此版本为作者自学修改后的程序包，为其添加了夹爪构建，并基于OpenCV与MoveIt!实现基于视觉的机械臂自主抓取实验仿真平台
* 仅为pkg文件，使用前需要自建workplace

## 环境安装

* 此部分详见原代码包中 README.md 文件（下文已给出）

* 原代码包链接：https://github.com/ps-micro/PROBOT_Anno
