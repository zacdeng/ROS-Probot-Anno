...
class GraspingDemo
{
  ...
  public:
	 ...
	 */
	void imageCb_Green(const sensor_msgs::ImageConstPtr &msg);
	void imageCb_Red(const sensor_msgs::ImageConstPtr &msg);
	void imageCb_Blue(const sensor_msgs::ImageConstPtr &msg);
	/**
