...
class VisionManager
{
   ...
   */
	 ...
	 */
	void get2DLocation_Green(cv::Mat img, float &x, float &y);
	void get2DLocation_Red(cv::Mat img, float &x, float &y);
	void get2DLocation_Blue(cv::Mat img, float &x, float &y);
  ...
  private:
	/**
 	 ...
 	 */
	void detect2DObject_Green(float &pixel_x, float &pixel_y, cv::Rect &tablePos);
	void detect2DObject_Red(float &pixel_x, float &pixel_y, cv::Rect &tablePos);
	void detect2DObject_Blue(float &pixel_x, float &pixel_y, cv::Rect &tablePos);
	/**
